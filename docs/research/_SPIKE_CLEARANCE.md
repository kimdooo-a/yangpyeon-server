...
| 2026-04-19 | SP-014 JWKS 캐시 3분 grace | SPIKE | Tech | 조건부 Go | docs/research/spikes/spike-014-jwks-cache-result.md | ADR-013 §s30 보완 ✅ (JWKS grace 엔드포인트 운용 명료화) |
| 2026-04-19 | SP-015 Session 인덱스 (SQLite vs PG) | SPIKE | Tech | Go | docs/research/spikes/spike-015-session-index-result.md | ADR-006 §s30 보완 ✅ (SHA-256 hex + 복합 인덱스 + cleanup job) |
| 2026-04-19 | SP-011 argon2id vs bcrypt | SPIKE | Tech | Go | docs/research/spikes/spike-011-argon2-result.md | ADR-019 신규 ✅ (argon2id 전환, supabase-parity 영역) |
| 2026-04-19 | SP-010 PM2 cluster:4 vs fork | SPIKE | Tech | 조건부 Go | docs/research/spikes/spike-010-pm2-cluster-result.md | ADR-015 §s30 보완 ✅ + `pm2 delete all` 운영 금지 규칙 |
...
| 2026-05-01 | SP-032 파일박스 large-file (1GB+) — 4단 게이트 해소 | SPIKE | Infra | **Go (PoC 6/6 합격, V1 옵션 A 적용)** | docs/research/spikes/spike-032-filebox-large-file-uploads.md | **ADR-032 (ACCEPTED 2026-05-01)** |
