...
// 출처: docs/assets/yangpyeon-aggregator-spec/code/src/lib/aggregator/fetchers/html.ts
// 변경 (multi-tenant 적응):
...
const DEFAULT_USER_AGENT = "YangpyeongBot/1.0 (+https://stylelucky4u.com; html scraper)";
...
/**
 * HTML 페이지 fetch + parserConfig 따라 RawItem[] 추출.
 * 셀렉터 명세 부실 시 throw — fetch 실패와 구분.
 */
