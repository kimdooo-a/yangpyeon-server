import { loadMasterKey, resolveMasterKeyPath } from "./MasterKeyLoader";
 ...
 *
 * MASTER_KEY_PATH env (기본 /etc/luckystyle4u/secrets.env, MasterKeyLoader.DEFAULT_MASTER_KEY_PATH)
 * 에서 key 로딩 → VaultService 인스턴스 생성 (프로세스 lifetime 유지).
 *
