    ...
    for (let i = 0; i < files.length; i++) {
      ...
      try {
        ...
        if (!res.ok) {
          ...
          lastError = data.error || `${file.name} 업로드 실패`;
        } else {
          successCount++;
        }
      } catch {
  ...
  return (
    ...
    >
      ...
      <div className="flex justify-center mb-3">
        <svg width="40" height="40" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" className={isDragOver ? "text-brand" : "text-gray-500"}>
      ...
      {uploading ? (
        <div>
          ...
          <div className="mt-3 h-1 w-48 mx-auto bg-surface-300 rounded-full overflow-hidden">
